...
<body>
    <div class="container-scroller">
        ...
        <div class="container mt-5">
            ...
            <form action="{{ route('meseromesas') }}" method="POST" class="mb-5">
                @csrf
                <div class="row">
                    <div class="col-md-3" >
                    ...
                    <div class="col-md-3">
                        <select style="background: #9c49fb; color: white" name="type" class="form-control" required>
                            <option style="background: #9c49fb; color: rgb(0, 0, 0)"value="" disabled selected>Tipo de Mesa</option>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card cardN {{ $table->status }}" >
                        <div class="card-body">
                            ...
                            <form action="{{ route('meseromesasdelete', $table->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
...
@endif
                ...
                <div class="modal fade" id="editModal{{ $table->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $table->id }}" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="{{ route('meseromesasupdate', $table->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="modal-header">
