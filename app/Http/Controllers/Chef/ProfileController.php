...
class ProfileController extends Controller
{
    ...
    public function store(ChefProfileRequest $request): RedirectResponse
    {
        ...
        if ($user->chef) {
            return redirect()->route('chef.profile.index')->with('error', 'Ya tienes un perfil, usa editar para modificarlo.');
        }
        ...
        return redirect()->route('chef.profile.index')->with('success', 'Perfil creado con éxito.');
    }
    ...
    public function edit(): View|RedirectResponse
    {
        ...
        if (! $user->chef) {
            return redirect()->route('chef.profile.index')->with('error', 'No tienes un perfil para editar.');
        }
    ...
    public function update(ChefProfileRequest $request): RedirectResponse
    {
        ...
        if (! $chef) {
            return redirect()->route('chef.profile.index')->with('error', 'Perfil no encontrado.');
        }
        ...
        return redirect()->route('chef.profile.index')->with('success', 'Perfil actualizado correctamente.');
    }
